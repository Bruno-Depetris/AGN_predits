...
namespace AGN_predits.Conexiones {
    internal class ConectarBD : IDisposable {

        private readonly HttpClient _httpClient;

        // Constructor: Inicializa el cliente con la URL base
        public ConectarBD(string baseUrl) {
